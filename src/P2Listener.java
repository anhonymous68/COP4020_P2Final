...
public interface P2Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link P2Parser#condition}.
	 * @param ctx the parse tree
	 */
	void enterCondition(P2Parser.ConditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link P2Parser#condition}.
	 * @param ctx the parse tree
	 */
	void exitCondition(P2Parser.ConditionContext ctx);
	/**
